                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="forms-sample" method="POST" action="{{ route('admin.update.password') }}"
                            ...
                            @csrf
                            <div class="mb-3">
                                <label for="exampleInputUsername1" class="form-label">Old_Password</label>
                            ...
                            <div class="mb-3">
                                <label for="exampleInputUsername1" class="form-label">New_Password</label>
                            ...
                            <div class="mb-3">
                                <label for="exampleInputUsername1" class="form-label">Confirm_New_Password</label>
